...
include_once SITE_SRC.'MarketplaceWebServiceOrders/Client.php';
include_once SITE_SRC.'MarketplaceWebServiceOrders/Model/ListOrderItemsRequest.php';
...
// $request = new MarketplaceWebServiceOrders_Model_ListOrderItemsRequest(['AmazonOrderId'=>'114-2484491-1918656']);
 $request = new MarketplaceWebServiceOrders_Model_ListOrderItemsRequest();
 $request->setSellerId(MERCHANT_ID);
 //$request->setAmazonOrderId('114-2484491-1918656'); // 05-09-2017
  ...
  */
  ...
  function invokeListOrderItems(MarketplaceWebServiceOrders_Interface $service, $request)
  {
      try {
        ...
        return $xml = simplexml_load_string($response->toXML());
...
//        echo("ResponseHeaderMetadata: " . $ex->getResponseHeaderMetadata() . "\n");
        $xml = simplexml_load_string($ex->getXML());
